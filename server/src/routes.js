...
module.exports = (app) => {
  ...
  //Student Routes
  app.post("/api/student/register", auth.verifyOTP, StudentController.registerStudent);
  ...
  app.post("/api/faculty/register", auth.verifyOTP, FacultyController.registerFaculty);
